...
def run_all_up_models(
    ...
    for model_config in model_configs:
        ...
        print("\n-----------------------------------")
        print(f"Train μP Model: {model_name}")
        print("-----------------------------------")
        ...
        partial_results_path = output_dir / "uP_training_results_partial.json"

        with open(partial_results_path, "w", encoding="utf-8") as f:
            json.dump(all_results, f, indent=2)

    results_json_path = output_dir / "uP_training_results.json"
    ...
    results_csv_path = output_dir / "uP_model_results.csv"
    ...
    print("\n-----------------------------------")
    print("All μP Model Training Finished")
    print("-----------------------------------")
